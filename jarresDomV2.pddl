...
:effect (and (assign (j3) 0)(increase (j4) (j3)))////////////////////
)
(:action transvider_j4_j3_cas1
:parameters ()
:precondition (and (not (= (j4) 0)) (not (= (j3) 3)) (<= (+ (j4) (j3)) 3) )
:effect (and (assign (j4) 0)(increase (j3) (j4)))
)
(:action transvider_j3_j4_cas2
:parameters ()
:precondition (and (not (= (j3) 0)) (not (= (j4) 4)) (> (+ (j3) (j4)) 4 ) )
:effect (and (assign (j4) 4) (increase (j3) (- (j4) 4)))
)
(:action transvider_j4_j3_cas2
:parameters ()
:precondition (and (not (= (j4) 0)) (not (= (j3) 3)) (> (+ (j4) (j3)) 3) )
:effect (and (assign (j3) 3) (increase (j4) (- (j3) 3)))
)
)